...
By using this model we can predict the proportion of medals that each country will win in future Summer Olympic games. Our model is already quite good, able to explain 86.61% of the variance. But we could improve the model accuracy by somehow including the athletes' information for each country, since some athletes perform much better that others.  
