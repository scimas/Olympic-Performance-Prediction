...
```
Below we can see the mean error in the prediction, which is 2.5 medals and the standard deviation is 21.81 medals. This indicated that the model error could have essentially been 0 because it falls in the 95% confidence interval. 
```{r echo = F}
